      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        >
          ...
          <motion.div
            ...
            className="rounded-2xl p-6 sm:p-8 lg:p-10 text-white bg-gradient-to-br from-purple-600 to-purple-800 min-h-[260px] sm:min-h-[300px] flex flex-col justify-between"
          >
            <div>
              <h3 className="uppercase text-base sm:text-lg font-semibold tracking-wide mb-4 sm:mb-6">
                Integrated Services
          ...
          <ServiceCard
            title="Web Development"
            tags="PHP  |  .NET  |  JAVA  |  JOOMLA"
            description="Lorem Ipsum is text of the printing and typesetting industry."
            bg="bg-[#e9edf6]"
            accent="bg-blue-400"
            icon="/development.svg"
          />
        ...
        <motion.div
          ...
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mt-6 sm:mt-8 lg:mt-10"
        >
          <ServiceCard
            title="Mobile App Development"
            tags="IPHONE  |  ANDROID  |  CROSS PLATFORM"
