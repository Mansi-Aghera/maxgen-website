      ...
      <section className="py-14 sm:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#0b1b3f] mb-6">
              Creative Web Design Service
            </h2>
          ...
          <div className="flex flex-wrap justify-center gap-6 sm:gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="group w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full bg-white shadow-md flex items-center justify-center hover:scale-110 transition"
              >
                <img
                  src={`/${img}`}
                  alt="tech"
      ...
      <section className="py-14 sm:py-16 text-center">
        <div className="max-w-6xl mx-auto px-4">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#0b1b3f] mb-10"
          >
            Our Services
          </motion.h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Graphic Designing Services", img: "/service-card1.svg" },
              { title: "Responsive Web Designing", img: "/service-card2.svg" },
              { title: "Static Website Designing", img: "/service-card3.svg" },
              { title: "Dynamic Website Designing", img: "/service-card4.svg" },
              { title: "Psd to HTML Service", img: "/service-card5.svg" },
              { title: "Website Redesign Service", img: "/service-card6.svg" },
            ].map((item, i) => (
              <motion.div
                key={i}
              ...
              >
                ...
                <h3 className="font-semibold text-[#0b1b3f]">
                  {item.title}
                </h3>
              </motion.div>
            ))}
        ...
        <div className="max-w-6xl mx-auto px-6 space-y-16">
          {[
            ...
            },
            {
              ...
              title: "Prototype",
              img: "/service-process2.jpg",
              desc: "We create wireframes and prototypes.",
            },
            {
              id: 3,
              title: "Development",
              img: "/service-process3.jpg",
              desc: "Our team starts coding.",
            },
            {
              id: 4,
              title: "Launch & Support",
              img: "/service-process4.jpg",
              desc: "We deploy and support.",
            },
          ].map((step, i) => {
            const even = i % 2 === 1;
            return (
              ...
              >
                ...
                <div>
                  <div className="w-14 h-14 rounded-full bg-gray-200 flex items-center justify-center font-bold mb-4">
                    {step.id}
                  </div>
                  <h3 className="text-xl font-bold text-[#0b1b3f] mb-2">
                    {step.title}
                  </h3>
